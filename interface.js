...
function renderizarProposta(dadosProposta, tipo) {
    ...
    const dataCriacao = dadosProposta.dataCriacao !== 'N/A' ? new Date(dadosProposta.dataCriacao).toLocaleDateString('pt-BR') : 'N/A';
    const dataExpiracao = dadosProposta.dataExpiracao !== 'N/A' ? new Date(dadosProposta.dataExpiracao).toLocaleDateString('pt-BR') : 'N/A';
...
function renderizarCabecalhoDinamico(planosPremium, planosEconomica) {
    ...
    cabecalhoProposta.innerHTML = `
        ...
        <nav class="botoes-tipo-proposta">
            <button id="botao-premium" class="botoes-tipo-proposta__botao">Premium</button>
